...
public:
     ...
     */
    LambdaContext(const std::string& requestId, 
                  const std::string& functionName, 
                  const std::string& functionVersion = "1.0",
     ...
     */
    bool isTimeoutImminent(std::chrono::milliseconds bufferMs = std::chrono::milliseconds(1000)) const;
